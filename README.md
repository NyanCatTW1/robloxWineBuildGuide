...
`curl https://raw.githubusercontent.com/NyanCatTW1/robloxWineBuildGuide/main/roblox-wine-staging-v2.6.patch --output roblox-wine-staging-v2.6.patch`  
4. **Apply the patch**:  
`git apply roblox-wine-staging-v2.6.patch`  
